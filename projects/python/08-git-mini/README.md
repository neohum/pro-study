...
SHA-1 해시와 zlib 압축으로 blob, tree, commit 객체를 생성하고 복원하는 Git 코어
...
- hashlib SHA-1에 대한 실전 활용법과 원리를 다룹니다.

### 개념 2: zlib 압축

- zlib 압축에 대한 실전 활용법과 원리를 다룹니다.

### 개념 3: Content-Addressable Storage

- Content-Addressable Storage에 대한 실전 활용법과 원리를 다룹니다.

### 개념 4: Git 객체 포맷

- Git 객체 포맷에 대한 실전 활용법과 원리를 다룹니다.

### 개념 5: 바이너리 I/O

- 바이너리 I/O에 대한 실전 활용법과 원리를 다룹니다.
