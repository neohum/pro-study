# 04. 인메모리 CSV SQL 쿼리 엔진

## 무엇을 만드는가

CSV 데이터를 테이블로 로드하여 SELECT, WHERE, ORDER BY를 평가하는 미니 쿼리 엔진
...
- csv 모듈에 대한 실전 활용법과 원리를 다룹니다.

### 개념 2: SQL 토크나이저

- SQL 토크나이저에 대한 실전 활용법과 원리를 다룹니다.

### 개념 3: 람다 필터링

- 람다 필터링에 대한 실전 활용법과 원리를 다룹니다.

### 개념 4: 다중 키 정렬

- 다중 키 정렬에 대한 실전 활용법과 원리를 다룹니다.

### 개념 5: 프로젝션

- 프로젝션에 대한 실전 활용법과 원리를 다룹니다.
