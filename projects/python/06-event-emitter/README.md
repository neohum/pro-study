# 06. 비동기 이벤트 버스 (Pub/Sub)

## 무엇을 만드는가

이벤트 구독, 발행, 일회성 리스너(once), 와일드카드 매칭을 지원하는 이벤트 브로커
...
- 옵저버 패턴에 대한 실전 활용법과 원리를 다룹니다.

### 개념 2: 콜백 큐

- 콜백 큐에 대한 실전 활용법과 원리를 다룹니다.

### 개념 3: 이벤트 네임스페이스

- 이벤트 네임스페이스에 대한 실전 활용법과 원리를 다룹니다.

### 개념 4: 와일드카드 패턴

- 와일드카드 패턴에 대한 실전 활용법과 원리를 다룹니다.

### 개념 5: 메모리 누수 방지

- 메모리 누수 방지에 대한 실전 활용법과 원리를 다룹니다.
