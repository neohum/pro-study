# 02. 텍스트 통계 및 단어 빈도 분석기

## 무엇을 만드는가

텍스트 스트림을 읽어 단어 수, 줄 수, 빈도수 TOP N을 산출하는 텍스트 분석기
...
### 개념 1: collections.Counter

- collections.Counter에 대한 실전 활용법과 원리를 다룹니다.

### 개념 2: re 정규표현식

- re 정규표현식에 대한 실전 활용법과 원리를 다룹니다.

### 개념 3: sys.stdin 스트림

- sys.stdin 스트림에 대한 실전 활용법과 원리를 다룹니다.

### 개념 4: 제너레이터

- 제너레이터에 대한 실전 활용법과 원리를 다룹니다.

### 개념 5: 딕셔너리 정렬

- 딕셔너리 정렬에 대한 실전 활용법과 원리를 다룹니다.
