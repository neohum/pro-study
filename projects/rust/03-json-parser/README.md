...
재귀적 열거형(Box<JsonValue>)을 사용해 JSON을 AST로 파싱하고 문자열로 재구성
...
- 재귀적 타입과 Box의 원리와 관용적(Idiomatic) 러스트 코드 작성법을 다룹니다.

### 개념 2: 상태 머신 렉서

- 상태 머신 렉서의 원리와 관용적(Idiomatic) 러스트 코드 작성법을 다룹니다.

### 개념 3: Display 트레이트 구현

- Display 트레이트 구현의 원리와 관용적(Idiomatic) 러스트 코드 작성법을 다룹니다.

### 개념 4: 슬라이스 슬라이싱

- 슬라이스 슬라이싱의 원리와 관용적(Idiomatic) 러스트 코드 작성법을 다룹니다.

### 개념 5: Result 전파(?)

- Result 전파(?)의 원리와 관용적(Idiomatic) 러스트 코드 작성법을 다룹니다.
