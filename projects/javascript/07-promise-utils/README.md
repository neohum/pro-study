# 07. 바닥부터 만드는 Promise 유틸리티

## 무엇을 만드는가

all, allSettled, race, any를 네이티브 API에 의존하지 않고 직접 구현
...
- Promise 상태 기계의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 2: 카운터와 래치

- 카운터와 래치의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 3: 에러 집계(AggregateError)

- 에러 집계(AggregateError)의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 4: 비동기 타이밍

- 비동기 타이밍의 메커니즘과 베스트 프랙티스를 실습합니다.
