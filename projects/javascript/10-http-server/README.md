# 10. Node.js 기반 경량 HTTP 라우팅 서버

## 무엇을 만드는가

URL 경로 매칭, 쿼리스트링 파싱, JSON 직렬화 및 미들웨어 파이프라인을 구현
...
- HTTP 프로토콜의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 2: 라우팅 테이블

- 라우팅 테이블의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 3: 미들웨어 체인

- 미들웨어 체인의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 4: Content-Type 처리

- Content-Type 처리의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 5: 상태 코드

- 상태 코드의 메커니즘과 베스트 프랙티스를 실습합니다.
