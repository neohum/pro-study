# 02. Pub/Sub 패턴 이벤트 브로커

## 무엇을 만드는가

on, once, emit, off 및 네임스페이스 와일드카드를 지원하는 이벤트 발행/구독기
...
### 개념 1: 클래스와 Private 필드(#)

- 클래스와 Private 필드(#)의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 2: Map과 Set

- Map과 Set의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 3: 콜백 패턴

- 콜백 패턴의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 4: 메모리 누수 방지

- 메모리 누수 방지의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 5: 옵저버 패턴

- 옵저버 패턴의 메커니즘과 베스트 프랙티스를 실습합니다.
