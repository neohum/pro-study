# 01. 모던 ES2024 산술 계산기 CLI

## 무엇을 만드는가

연산자 우선순위와 괄호를 재귀적으로 처리하는 커맨드라인 계산기
...
- ES Modules의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 2: 클로저

- 클로저의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 3: 정규식 토큰화

- 정규식 토큰화의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 4: 재귀 하강 파싱

- 재귀 하강 파싱의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 5: 에러 핸들링

- 에러 핸들링의 메커니즘과 베스트 프랙티스를 실습합니다.
