# 04. 순환 참조 지원 Deep Clone & 객체 비교

## 무엇을 만드는가

WeakMap을 활용하여 순환 참조를 방지하고 Date, RegExp, Set, Map까지 복제하는 유틸리티
...
- WeakMap의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 2: 재귀 탐색

- 재귀 탐색의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 3: 타입 판별(typeof/toString)

- 타입 판별(typeof/toString)의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 4: Symbol

- Symbol의 메커니즘과 베스트 프랙티스를 실습합니다.

### 개념 5: 프로토타입 체인

- 프로토타입 체인의 메커니즘과 베스트 프랙티스를 실습합니다.
