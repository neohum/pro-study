# 04. 타입 안전 유한 상태 머신 (FSM)

## 무엇을 만드는가

상태(States)와 전이(Transitions)를 타입 수준에서 강제하는 결정론적 상태 머신
...
- Mapped Types에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 2: Keyof & Indexed Access

- Keyof & Indexed Access에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 3: Exhaustive Check (never)

- Exhaustive Check (never)에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 4: Event Mapping

- Event Mapping에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 5: State Pattern

- State Pattern에 대한 심층 원리와 설계 패턴을 다룹니다.
