# 06. 타입 안전 Event Emitter

## 무엇을 만드는가

이벤트 맵(EventMap) 제네릭을 기반으로 이벤트 이름과 페이로드 타입을 100% 검증
...
### 개념 1: Generic EventMap

- Generic EventMap에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 2: Indexed Access Types

- Indexed Access Types에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 3: Rest Parameters with Tuples

- Rest Parameters with Tuples에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 4: Once & Off

- Once & Off에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 5: Pub/Sub

- Pub/Sub에 대한 심층 원리와 설계 패턴을 다룹니다.
