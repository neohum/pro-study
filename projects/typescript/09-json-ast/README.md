# 09. JSON AST 파서 & 타입 변환기

## 무엇을 만드는가

JSON 문자열을 구문 분석하여 강력한 타입의 AST 노드 트리로 변환하고 순회
...
### 개념 1: Recursive Type Definition

- Recursive Type Definition에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 2: Tagged Union AST

- Tagged Union AST에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 3: Visitor Pattern

- Visitor Pattern에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 4: Recursive Descent Parsing

- Recursive Descent Parsing에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 5: JSON Serialization

- JSON Serialization에 대한 심층 원리와 설계 패턴을 다룹니다.
