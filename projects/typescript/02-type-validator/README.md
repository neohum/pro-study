# 02. 런타임 스키마 검증기 (Zod-like)

## 무엇을 만드는가

정적 타입 추론(infer)과 런타임 유효성 검증을 결합한 타입스크립트 스키마 라이브러리
...
### 개념 1: Type Inference (infer)

- Type Inference (infer)에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 2: Generic Constraints

- Generic Constraints에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 3: Conditional Types

- Conditional Types에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 4: 타입 서술어(is)

- 타입 서술어(is)에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 5: Builder Pattern

- Builder Pattern에 대한 심층 원리와 설계 패턴을 다룹니다.
