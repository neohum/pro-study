# 10. 타입 안전 Trie 기반 HTTP 라우터

## 무엇을 만드는가

URL 경로의 파라미터(:id) 타입을 추출하고 핸들러 매핑을 검증하는 고속 라우팅 엔진
...
### 개념 1: Template Literal Param Extraction

- Template Literal Param Extraction에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 2: Radix/Trie Tree

- Radix/Trie Tree에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 3: Route Match Result

- Route Match Result에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 4: Middleware Pipeline

- Middleware Pipeline에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 5: HTTP Methods

- HTTP Methods에 대한 심층 원리와 설계 패턴을 다룹니다.
