# 08. 타입 안전 의존성 주입 (DI) 컨테이너

## 무엇을 만드는가

서비스 토큰과 생성자 주입을 통해 Singleton/Transient 수명 주기를 제어하는 IoC 컨테이너
...
### 개념 1: Constructor Type (new (...args: any[]) => T)

- Constructor Type (new (...args: any[]) => T)에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 2: InjectionToken<T>

- InjectionToken<T>에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 3: Inversion of Control

- Inversion of Control에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 4: Factory Pattern

- Factory Pattern에 대한 심층 원리와 설계 패턴을 다룹니다.

### 개념 5: Lifetime Management

- Lifetime Management에 대한 심층 원리와 설계 패턴을 다룹니다.
